...
const Footer = () => {
    return (
        <>
            <footer className="bg-white mx-auto dark:bg-gray-900 w-full border-t mt-10">
                <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div className="mx-auto">
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li className="mb-4">
                                <Link href="/get-the-app" className="hover:underline">Get the App</Link>
                            </li>
                            <li className="mb-4">
                ...
                <div className="px-20 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© {new Date().getFullYear()} <Link href="https://flowbite.com/">Flowbite™</Link>. All Rights Reserved.
                    </span>
